...
public class FlightService {
	...
	public String printRoute(Route r, int count) {
		return count + ") " + r.getSource().getIataId() + ", " + r.getSource().getCity() + " -> "
				+ r.getDestination().getIataId() + ", " + r.getDestination().getCity();
	}
	...
	/**
	 * sets booking.active to true and booking_payment.refunded to false updates
	 * flight seats
	 * 
	 * @param user
	 * @param f
